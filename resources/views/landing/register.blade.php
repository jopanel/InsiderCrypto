...
<head>
  ...
  <!-- Bootstrap core CSS-->
  <link href="<?=URL::to('/')?>/resources/main/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
...
<body style="background-image: url(<?=URL::to('/')?>/resources/img/homebg.png); background-position:center; background-color: white;">
  <div class="container">
    <div class="row">
      <div class="col text-center" style="padding-top:50px;">
        <a href="<?=URL::to('/')?>/">
          <img src="<?=URL::to('/')?>/resources/img/homelogo.png" class="img-fluid header-logo">
        </a>
      </div>
    </div>
...
box-shadow: 30px 30px 138px -32px rgba(0,0,0,0.75); border-radius:10px;">
      ...
      <div class="card-body">
        ...
        <form method="post" action="<?=URL::to('/')?>/access/register">
          ...
          <p>By registering you agree to our <a href="<?=URL::to('/')?>/docs/privacy">privacy policy</a> and <a href="<?=URL::to('/')?>/docs/terms">terms of service</a>.</p>
          
          <input type="submit" class="btn btn-primary btn-block" value="Register">
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="<?=URL::to('/')?>/access/login">Login Page</a>
          <a class="d-block small" href="<?=URL::to('/')?>/access/forgot">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
