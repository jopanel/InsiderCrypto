...
<body class="fixed-nav sticky-footer bg-dark <?=$navbartoggle?>" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?=URL::to('/')?>/">Insider Crypto</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Help">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            ...
            <li>
              <a href="<?=URL::to('/')?>/docs/privacy">Privacy Policy</a>
            </li>
            <li>
              <a href="<?=URL::to('/')?>/docs/terms">Terms of Service</a>
            </li>
          </ul>
        </li>
      </ul>
